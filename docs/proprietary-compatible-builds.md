...
- Set `OSCI_GUI_ENABLE_OSCI_PARAMETERS=1` to expose osci-render-specific parameter and MIDI-CC controls. It defaults off for proprietary-compatible builds; consumers enabling it must add `osci_render_core` explicitly.
