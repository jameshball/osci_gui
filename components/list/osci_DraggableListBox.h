...
public:
    ...
    bool isInterestedInDragSource(const SourceDetails& details) override {
        return dragSourceFilter == nullptr || dragSourceFilter(details);
    }
    ...
    void setDragSourceFilter(std::function<bool(const SourceDetails&)> filter) {
        dragSourceFilter = std::move(filter);
    }
...
private:
    ...
    std::function<bool(const SourceDetails&)> dragSourceFilter;
...
public:
    ...
    // DragAndDropTarget
    bool isInterestedInDragSource(const SourceDetails& details) override {
        return listBox.isInterestedInDragSource(details);
    }
